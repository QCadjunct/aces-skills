...
SKILL_NAME       = "ACES_daily_diary"
SKILL_FQSN       = "TaskArchitecture/DiaryWriter/ACES_daily_diary"
...
def main() -> int:
    ...
    output_path = os.environ.get("ACES_OUTPUT_PATH", "")
