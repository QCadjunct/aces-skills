...
# FQSN
MetaArchitecture/ACMS_skill_deployers/ACMS_skill_deploy_generators
...
Derived from source path — last path component:
  source: ~/.config/fabric/patterns_custom/ACMS_Skills/CodingArchitecture/FabricStitch/ACMS_extract_wisdom/system.md
  skill_folder: ACMS_extract_wisdom
