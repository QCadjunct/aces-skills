#!/usr/bin/env bash
# ============================================================
# ACES_skill_deploy_generators — deploy_generators.sh
...
usage() {
    ...
    echo "  deploy_generators.sh --source ~/.config/fabric/patterns_custom/ACES_Skills/CodingArchitecture/FabricStitch/ACES_extract_wisdom/system.md"
...
echo -e "${GRN}${BLD}  ACES_skill_deploy_generators — DONE   ${RST}" >&2
echo -e "${GRN}${BLD}════════════════════════════════════════${RST}" >&2
