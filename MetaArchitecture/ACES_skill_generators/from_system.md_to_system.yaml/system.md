...
name: Extract the skill name from the # Identity heading or the first H1.
  Convert to snake_case. Remove "ACES_" prefix only if it creates ambiguity.
...
identity:
  name: ACES_extract_wisdom
  version: 1.0.0
  domain: CodingArchitecture
  subdomain: FabricStitch
  fqsn: CodingArchitecture/FabricStitch/ACES_extract_wisdom
contract:
