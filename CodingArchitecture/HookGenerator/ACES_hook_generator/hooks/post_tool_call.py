#!/usr/bin/env python3
# post_tool_call.py
# ACES Lifecycle Hook — Post Tool Call
# Skill:     ACES_extract_wisdom
# Domain:    CodingArchitecture/FabricStitch
# Generated: 2026-03-14
# Generator: ACES_hook_generator (CodingArchitecture/HookGenerator)
...
# ── Skill constants ────────────────────────────────────────────────────────────
SKILL_NAME  = "ACES_extract_wisdom"
SKILL_FQSN  = "CodingArchitecture/FabricStitch/ACES_extract_wisdom"
...
def main() -> int:
    ...
    tool_name  = os.environ.get("ACES_TOOL_NAME", "unknown")
    exit_code  = int(os.environ.get("ACES_TOOL_EXIT_CODE", "0"))
    tokens_in  = int(os.environ.get("ACES_TOKENS_IN", "0"))
    tokens_out = int(os.environ.get("ACES_TOKENS_OUT", "0"))
    ...
    constraint_warnings = []
    output_text = os.environ.get("ACES_TOOL_OUTPUT", "")
    ...
    vendor = os.environ.get("ACES_VENDOR", "ollama").lower()
    model  = os.environ.get("ACES_MODEL", "qwen3:8b")
    env    = os.environ.get("ACES_ENV", "dev")
