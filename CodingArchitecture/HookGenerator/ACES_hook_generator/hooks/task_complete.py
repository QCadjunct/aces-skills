...
# ACES_extract_wisdom writes extracted wisdom to stdout or a named output file
...
def main() -> int:
    ...
    run_id   = os.environ.get("ACES_RUN_ID", "unknown")
    upstream = os.environ.get("ACES_UPSTREAM_ID", "")
