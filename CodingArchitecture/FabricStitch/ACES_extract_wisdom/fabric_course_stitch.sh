...
t=$(step_start "Step 1/5" "ACES_extract_wisdom" "$STEP1_VENDOR" "$STEP1_MODEL")
...
for entry in \
  "${TS}|fabric_course_stitch|${RUN_ID}|CodingArchitecture/FabricStitch/ACES_extract_wisdom|step_1|${STEP1_VENDOR}|${STEP1_MODEL}|${IN1}|${OUT1}|0|0|${COST1}|${DUR1}|dev|${RUN_ID}|extract_wisdom" \
  "${TS}|fabric_course_stitch|${RUN_ID}|CodingArchitecture/FabricStitch/ACES_extract_wisdom|step_2|${STEP2_VENDOR}|${STEP2_MODEL}|${IN2}|${OUT2}|0|0|${COST2}|${DUR2}|dev|${RUN_ID}|summarize" \
  "${TS}|fabric_course_stitch|${RUN_ID}|CodingArchitecture/FabricStitch/ACES_extract_wisdom|step_3|${STEP3_VENDOR}|${STEP3_MODEL}|${IN3}|${OUT3}|0|0|${COST3}|${DUR3}|dev|${RUN_ID}|extract_insights" \
  "${TS}|fabric_course_stitch|${RUN_ID}|CodingArchitecture/FabricStitch/ACES_extract_wisdom|step_4|${STEP4_VENDOR}|${STEP4_MODEL}|${IN4}|${OUT4}|0|0|${COST4}|${DUR4}|dev|${RUN_ID}|${SYNTHESIS_PATTERN}" \
  "${TS}|fabric_course_stitch|${RUN_ID}|CodingArchitecture/FabricStitch/ACES_extract_wisdom|session.total|all|all|${total_in}|${total_out}|0|0|${total_cost}|${pipeline_ms}|dev|${RUN_ID}|pipeline_complete"
do
  echo "$entry" >> "$COST_LOG"
done
echo ""
