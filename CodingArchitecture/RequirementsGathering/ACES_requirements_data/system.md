...
# FQSN
CodingArchitecture/RequirementsGathering/ACES_requirements_data
...
- Dispatched via fabric --pattern ACES_requirements_data
- Deployed to: ~/.config/fabric/patterns_custom/ACES_requirements_data/
