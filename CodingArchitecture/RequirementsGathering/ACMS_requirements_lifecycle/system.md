...
# FQSN
CodingArchitecture/RequirementsGathering/ACMS_requirements_lifecycle
...
- Dispatched via fabric --pattern ACMS_requirements_lifecycle
- Deployed to: ~/.config/fabric/patterns_custom/ACMS_requirements_lifecycle/
