...
# FQSN
CodingArchitecture/RequirementsGathering/ACMS_requirements_cost_model
...
- Dispatched via fabric --pattern ACMS_requirements_cost_model
- Deployed to: ~/.config/fabric/patterns_custom/ACMS_requirements_cost_model/
