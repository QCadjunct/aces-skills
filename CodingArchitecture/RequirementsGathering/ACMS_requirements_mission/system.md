...
# FQSN
CodingArchitecture/RequirementsGathering/ACMS_requirements_mission
...
- Dispatched via fabric --pattern ACMS_requirements_mission
- Deployed to: ~/.config/fabric/patterns_custom/ACMS_requirements_mission/
